...
>>>>>>> f4effe2260fcd82a1c32f4723c9e7cc35fa492f9
    axios
      .post("http://127.0.0.1:4000/summary", input)
      .then((res) => {
        setSummarizedText(res.data.output);
<<<<<<< HEAD
        setWordCount(res.data.output.length);
=======
        setWordCount(res.data.output.length)
>>>>>>> f4effe2260fcd82a1c32f4723c9e7cc35fa492f9
      })
...
<<<<<<< HEAD
    <>
      {isLoading && <SmartTextAnalyzerLoading isLoading={isLoading} />}
...
<<<<<<< HEAD
            <main className="mt-6 flex-1 flex flex-col">
              ...
              <div className="mt-4 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                <button
                  disabled={isLoading}
                  className={`bg-[var(--primary-color)] text-white font-semibold py-2 px-6 rounded-md text-sm w-full sm:w-auto ${
